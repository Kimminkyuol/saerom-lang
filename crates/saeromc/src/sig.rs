...
const BUILTIN: &[(&str, &[Marker])] = &[
    ...
    ("잇다", &[Marker::Case("를")]),
    ("잇다", &[Marker::Case("를"), Marker::Case("로")]),
    ...
    ("시작하다", &[Marker::Case("가"), Marker::Case("로")]),
    ("담다", &[Marker::Case("가"), Marker::Case("를")]),
    ("끝나다", &[Marker::Case("가"), Marker::Case("로")]),
    ("다듬다", &[Marker::Case("를")]),
    ("자르다", &[Marker::Case("를"), Marker::Case("로")]),
    ("읽다", &[Marker::Case("를")]),
    ("입력받다", &[]),
    ("열다", &[Marker::Case("를")]),
